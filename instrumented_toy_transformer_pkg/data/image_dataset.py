...
with __import__("torch").profiler.record_function("TB:image_dataset.Block2 torch=torch.randn"):
    import random
    ...
    class ImageDataset(Dataset):
        ...
        def _make_example(self) -> Tuple[torch.Tensor, int]:
            with __import__("torch").profiler.record_function("TB:image_dataset.ImageDataset._make_example.Block9 torch=torch.randn.float|torch.randn"):
                image = torch.randn(
